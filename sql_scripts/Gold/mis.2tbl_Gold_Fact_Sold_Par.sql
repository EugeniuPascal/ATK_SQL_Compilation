...
-----------------------------------------------------
-- Step 1: Max Past Days (temp table)
-----------------------------------------------------
...
-----------------------------------------------------
-- Step 2: Shadow Branch (temp table)
-----------------------------------------------------
...
-----------------------------------------------------
-- Step 3: Responsible / Expert (temp table)
-----------------------------------------------------
...
-----------------------------------------------------
-- Prepare ranges for Responsible & ShadowBranch
-----------------------------------------------------
;WITH RespRanges AS (
    SELECT 
        CreditID,
...
-----------------------------------------------------
-- Step 5: Main Insert with IRR fixed
-----------------------------------------------------
