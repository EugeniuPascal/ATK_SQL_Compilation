...
IF OBJECT_ID('mis.[2tbl_Gold_Fact_Disbursement1]', 'U') IS NOT NULL
    DROP TABLE mis.[2tbl_Gold_Fact_Disbursement1];
GO

CREATE TABLE mis.[2tbl_Gold_Fact_Disbursement1] 
(
...
INSERT INTO mis.[2tbl_Gold_Fact_Disbursement1]
(
...
ON mis.[2tbl_Gold_Fact_Disbursement1] (DisbursementDate ASC, ClientID ASC);

CREATE NONCLUSTERED INDEX IX_Disbursement_CreditID
ON mis.[2tbl_Gold_Fact_Disbursement1] (CreditID);

CREATE NONCLUSTERED INDEX IX_Disbursement_FirstFilialID
ON mis.[2tbl_Gold_Fact_Disbursement1] (FirstFilialID);

CREATE NONCLUSTERED INDEX IX_Disbursement_LastFilialID
ON mis.[2tbl_Gold_Fact_Disbursement1] (LastFilialID);

CREATE NONCLUSTERED INDEX IX_Disbursement_NewExisting
ON mis.[2tbl_Gold_Fact_Disbursement1] (NewExisting_Client);

CREATE NONCLUSTERED INDEX IX_Disbursement_ClientID
ON mis.[2tbl_Gold_Fact_Disbursement1] (ClientID);
GO
