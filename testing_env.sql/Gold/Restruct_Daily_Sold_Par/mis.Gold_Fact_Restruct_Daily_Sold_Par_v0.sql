...
PRINT N'=== Пересборка [mis].[Gold_Fact_Restruct_Daily_Min1] за период '
...
/* ================== ЦЕЛЕВАЯ ТАБЛИЦА ================== */
IF OBJECT_ID('[mis].[Gold_Fact_Restruct_Daily_Min1]', 'U') IS NOT NULL
    DROP TABLE [mis].[Gold_Fact_Restruct_Daily_Min1];

CREATE TABLE [mis].[Gold_Fact_Restruct_Daily_Min1] 
(
...
-- FINAL INSERT
---------------------------------------------------------
INSERT INTO [mis].[Gold_Fact_Restruct_Daily_Min1]
(
    SoldDate,
    CreditID,
    ClientID,
