...
;WITH cte AS (
	...
	--AND s.[СуммыЗадолженностиПоПериодамПросрочки Кредит ID] = 'B76200155D65140C11EE8382F89DD700'
)
SELECT *
INTO #Base
FROM cte WHERE rn = 1;
...
;WITH MinFrom AS (
	...
	--WHERE CreditID = 'B76200155D65140C11EE8382F89DD700'
    GROUP BY CreditID
)
...
--WHERE [УстановкаДанныхКредита Кредит ID] = 'B76200155D65140C11EE8382F89DD700'
...
FROM Dedup d
WHERE d.rn = 1
--AND d.CreditID = 'B76200155D65140C11EE8382F89DD700'
OPTION (RECOMPILE);
