...
-----------------------------------------------------
DROP TABLE IF EXISTS mis.[Gold_Fact_Sold_Par_2022_Present];

CREATE TABLE mis.[Gold_Fact_Sold_Par_2022_Present] 
(
...
INSERT INTO mis.[Gold_Fact_Sold_Par_2022_Present] WITH (TABLOCK)
(
...
-- Columnstore
-----------------------------------------------------
CREATE CLUSTERED COLUMNSTORE INDEX CCSI_Gold_Fact_Sold_Par_2022_Present
ON mis.[Gold_Fact_Sold_Par_2022_Present];
